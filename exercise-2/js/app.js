...
localStorage.setItem("completedTasksHolder", JSON.stringify(completedTasksHolder));
localStorage.setItem("incompleteTasksHolder", JSON.stringify(incompleteTasksHolder));
          
localStorage.getItem("completedTasksHolder");
localStorage.getItem("incompleteTasksHolder");
